...
public final class FaceSessionClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> createLivenessWithVerifySessionWithResponse(BinaryData livenessSessionCreationContent,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    LivenessSessionWithVerifyCreationResult createLivenessWithVerifySessionWithVerifyImage(
        ...
        return createLivenessWithVerifySessionWithVerifyImageWithResponse(new MultipartFormDataHelper(requestOptions)
            ...
            .end()
            .getRequestBody(), requestOptions).getValue().toObject(LivenessSessionWithVerifyCreationResult.class);
    }
