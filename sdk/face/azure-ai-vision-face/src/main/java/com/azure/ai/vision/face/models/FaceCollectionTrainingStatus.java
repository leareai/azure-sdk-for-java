 ...
 */
@Immutable
public final class FaceCollectionTrainingStatus implements JsonSerializable<FaceCollectionTrainingStatus> {
    /*
    ...
    /**
     * Creates an instance of FaceCollectionTrainingStatus class.
     * 
     ...
     */
    @Generated
    private FaceCollectionTrainingStatus(FaceOperationState status, OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of FaceCollectionTrainingStatus from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of FaceCollectionTrainingStatus if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the FaceCollectionTrainingStatus.
     */
    @Generated
    public static FaceCollectionTrainingStatus fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            FaceCollectionTrainingStatus deserializedFaceCollectionTrainingStatus = new FaceCollectionTrainingStatus(
                status, createdDateTime, lastActionDateTime, lastSuccessfulTrainingDateTime);
            deserializedFaceCollectionTrainingStatus.message = message;

            return deserializedFaceCollectionTrainingStatus;
        });
    }
}
